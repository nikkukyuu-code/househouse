...
} from './house.js?v=20260920e';
import { NetSession, loadPeerJS, isPeerAvailable, isValidRoomCode, normalizeRoomCode } from './net.js?v=20260920e';
import { $, showScreen, setStatus, heartsHtml, bindHold, bindTap, lockTouch, flashOverlay } from './ui.js?v=20260920e';
import { unlockAudio, loadMutePref, setMuted, isMuted, play as sfx } from './sound.js?v=20260920e';
